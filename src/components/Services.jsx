...
const Services = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      mm.add("(max-width: 767px)", () => {
        // MOBILE animations - simple fade-ins only
      ...
      mm.add("(min-width: 768px)", () => {
        // DESKTOP animations with pinning
  ...
  if (!isClient) {
    // Return basic structure without animations during SSR
    return (
      <section
        id="services"
        ref={sectionRef}
      ...
      >
        <div
          ...
          style={{ minHeight: `${TITLE_BAR_HEIGHT_DESKTOP}px` }}
        >
        ...
        <div className="md:hidden pb-12 pl-5">
          <div className="flex gap-5 overflow-x-auto pb-6 pr-5">
            {services.map((service, index) => (
              <div key={index} className="flex-shrink-0 w-[80vw]">
                <div className="bg-black border border-[#3a3633] rounded-2xl p-6">
                  <div className="mb-4">
  ...
  const titleBarHeight = typeof window !== 'undefined' && window.innerWidth < 768 
    ? TITLE_BAR_HEIGHT_MOBILE 
    : TITLE_BAR_HEIGHT_DESKTOP;
  ...
  return (
    ...
    >
      ...
      <div
        ref={titleWrapperRef}
        className="bg-black z-30 flex items-end rounded-t-3xl pt-6 pb-3"
        style={{ minHeight: `${titleBarHeight}px` }}
      >
        <div className="content-container px-5 md:px-10 w-full">
          <div className="w-full overflow-visible">
            <h2
