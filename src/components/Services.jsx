...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={titleWrapperRef}
        className="bg-black z-30 flex items-end rounded-t-3xl"
        style={{ 
          height: 'auto',
          minHeight: '100px',
          paddingTop: '0',
      ...
      >
        <div className="content-container px-5 md:px-10 md:pt-8 w-full">
          <div className="w-full overflow-hidden">
            <h2
              ref={titleRef}
              className="services-title text-4xl md:text-5xl lg:text-[7rem] font-semibold text-[#d1d1c7] tracking-[-0.05em] leading-none"
            >
              WHAT I DO /
            </h2>
          </div>
